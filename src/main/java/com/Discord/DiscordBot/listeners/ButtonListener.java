...
public class ButtonListener extends ListenerAdapter {
    ...
    private void handleNewQuestion(ButtonInteractionEvent event, User user) {
        ...
        if (unit == 1) {
            ...
            question = QuestionBank.getRandomQuestion(QuestionBank.getUnit5Questions(), prevQuestionId);
        } else if (unit == 6) {
            question = QuestionBank.getRandomQuestion(QuestionBank.getUnit6Questions(), prevQuestionId);
        } else if (unit == 7) {
            question = QuestionBank.getRandomQuestion(QuestionBank.getUnit7Questions(), prevQuestionId);
        } else if (unit == 8) {
            question = QuestionBank.getRandomQuestion(QuestionBank.getUnit8Questions(), prevQuestionId);
        } else if (unit == 9) {
            question = QuestionBank.getRandomQuestion(QuestionBank.getUnit9Questions(), prevQuestionId);
        }  else if (unit == 10) {
            question = QuestionBank.getRandomQuestion(QuestionBank.getUnit10Questions(), prevQuestionId);
        } else {
